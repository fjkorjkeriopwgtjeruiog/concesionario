...
- Cliente: id, nombre, dni, fecha_registro
...
- Cada una de las 5 listas deben tambien incluir un botón que lleve a un formulario que permita crear un nuevo registro en esa tabla en particular. En el caso de cliente y empleado, usaras como fecha de inscripción/contratación la fecha en actual.
...
- Crearás una variable 'deuda' para los clientes. Al vender un coche, no permitiras la venta de coches a clientes que deban dinero, y si la venta se realiza con exito, el precio del coche pasará a ser la deuda a saldar de dicho cliente.
